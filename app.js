...
require.register("react-transition-group/CSSTransition.js", function(exports, require, module) {
...
require.register("react-transition-group/ReplaceTransition.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"transform":["loose-envify"]}, "react-transition-group");
  (function() {
    'use strict';
...
ReplaceTransition.propTypes = 'development' !== "production" ? propTypes : {};
...
require.register("react-transition-group/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"transform":["loose-envify"]}, "react-transition-group");
  (function() {
    'use strict';
...
require.register("actions/index.js", function(exports, require, module) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var freshCode = exports.freshCode = function freshCode(code) {
  return {
    type: 'FRESH_CODE',
    code: code
  };
...
var _ProgramPane = require('./ProgramPane');

var _ProgramPane2 = _interopRequireDefault(_ProgramPane);

var _StackPane = require('./StackPane');

var _StackPane2 = _interopRequireDefault(_StackPane);
...
var App = function App() {
  return _react2.default.createElement(
    'div',
    { id: 'app' },
    _react2.default.createElement(_EditorPane2.default, null),
    _react2.default.createElement(_ProgramPane2.default, null),
    _react2.default.createElement(_StackPane2.default, null)
  );
};
...
;require.register("components/CompileButton.jsx", function(exports, require, module) {
'use strict';
...
var CompileButton = function CompileButton(_ref) {
  var onCompile = _ref.onCompile;
  return _react2.default.createElement(
    'button',
    { id: 'compile-button', onClick: function onClick(e) {
        return onCompile();
      } },
    'Load'
  );
...
CompileButton.propTypes = {
  onCompile: _propTypes2.default.func.isRequired
};
...
var Editor = function Editor(_ref) {
  var code = _ref.code,
      onFreshCode = _ref.onFreshCode;
  return _react2.default.createElement('textarea', {
    id: 'editor',
    value: code,
    onChange: function onChange(e) {
      return onFreshCode(e.target.value);
    }
  });
};
...
Editor.propTypes = {
  ...
  onFreshCode: _propTypes2.default.func.isRequired
};

exports.default = Editor;
});

;require.register("components/EditorPane.jsx", function(exports, require, module) {
'use strict';
...
var _CompileButton = require('../containers/CompileButton');

var _CompileButton2 = _interopRequireDefault(_CompileButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var EditorPane = function EditorPane() {
  return _react2.default.createElement(
    'div',
    { className: 'pane', id: 'editor-pane' },
    _react2.default.createElement(_CompileButton2.default, null),
...
;require.register("components/ProgramMemory.jsx", function(exports, require, module) {
'use strict';
...
var Instruction = function Instruction(key, instruction, parameters, highlight) {
  return _react2.default.createElement(
    'div',
    {
      key: key,
...
var ProgramMemory = function ProgramMemory(_ref) {
  var pc = _ref.pc,
      instructions = _ref.instructions;
  return _react2.default.createElement(
    'div',
    { id: 'instructions' },
    instructions.map(function (l, i) {
      return Instruction(i, l.instruction, l.parameters, i == pc);
    })
  );
};

ProgramMemory.propTypes = {
  instructions: _propTypes2.default.arrayOf(_propTypes2.default.shape({ instruction: _propTypes2.default.string, parameters: _propTypes2.default.any })).isRequired,
  pc: _propTypes2.default.number.isRequired
};

exports.default = ProgramMemory;
});

;require.register("components/ProgramPane.jsx", function(exports, require, module) {
'use strict';
...
var _ProgramMemory = require('../containers/ProgramMemory');

var _ProgramMemory2 = _interopRequireDefault(_ProgramMemory);

var _StepButton = require('../containers/StepButton');

var _StepButton2 = _interopRequireDefault(_StepButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ProgramPane = function ProgramPane() {
  return _react2.default.createElement(
    'div',
    { className: 'pane', id: 'program-pane' },
    _react2.default.createElement(_StepButton2.default, null),
    _react2.default.createElement(_ProgramMemory2.default, null)
  );
};

exports.default = ProgramPane;
});

;require.register("components/Stack.jsx", function(exports, require, module) {
'use strict';
...
var StackItem = function StackItem(index, item) {
  return _react2.default.createElement(
...
var Stack = function Stack(_ref) {
  ...
  return _react2.default.createElement(
    ...
    { id: 'stack', className: 'stack' },
    stack.map(function (s, i) {
      return StackItem(i, s);
    })
  );
};

Stack.propTypes = {
  stack: _propTypes2.default.arrayOf(_propTypes2.default.number)
};

exports.default = Stack;
});

;require.register("components/StackPane.jsx", function(exports, require, module) {
'use strict';
...
var _Stack = require('../containers/Stack');

var _Stack2 = _interopRequireDefault(_Stack);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var StackPane = function StackPane() {
  return _react2.default.createElement(
    'div',
    { className: 'pane', id: 'stack-pane' },
...
;require.register("components/StepButton.jsx", function(exports, require, module) {
'use strict';
...
var StepButton = function StepButton(_ref) {
  ...
  return _react2.default.createElement(
    'button',
    { id: 'step-button', onClick: function onClick(e) {
        return onStep();
      } },
    'Step'
  );
...
;require.register("containers/CompileButton.js", function(exports, require, module) {
'use strict';
...
var _CompileButton = require('../components/CompileButton');
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onCompile: function onCompile() {
      return dispatch((0, _actions.compile)());
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CompileButton2.default);
});

;require.register("containers/Editor.js", function(exports, require, module) {
'use strict';
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onFreshCode: function onFreshCode(code) {
      return dispatch((0, _actions.freshCode)(code));
    }
  };
};
...
;require.register("containers/ProgramMemory.js", function(exports, require, module) {
'use strict';
...
var _ProgramMemory = require('../components/ProgramMemory');
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ProgramMemory2.default);
});

;require.register("containers/Stack.js", function(exports, require, module) {
'use strict';
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Stack2.default);
});

;require.register("containers/StepButton.js", function(exports, require, module) {
'use strict';
...
var _StepButton = require('../components/StepButton');
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onStep: function onStep() {
      return dispatch((0, _actions.step)());
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_StepButton2.default);
});
...
;require.register("reducers/machine.js", function(exports, require, module) {
'use strict';
...
var parseNoParameters = function parseNoParameters(instruction, parameters) {
...
var parseIntParameter = function parseIntParameter(instruction, parameters) {
...
var parseLine = function parseLine(line) {
  var _line$trim$split = line.trim().split(/\s+/),
      ...
      instruction = _line$trim$split2[0],
      parameters = _line$trim$split2.slice(1);
...
var push_stack = function push_stack(stack, item) {
  return [].concat(_toConsumableArray(stack.slice()), [item]);
};

var pop_stack = function pop_stack(stack) {
  if (stack.length == 0) {
    throw "Stack empty";
  }
...
var cycle_stack = function cycle_stack(stack, index) {
  var split = stack.length - index;
  if (index <= 0 || index > stack.length) {
    throw "Stack index out of range";
  }

  return [].concat(_toConsumableArray(stack.slice(0, split)), _toConsumableArray(stack.slice(split + 1)), [stack[split]]);
};

var run_instruction = function run_instruction(pc, instructions, stack) {
  if (pc < 0 || pc >= instructions.length) {
    throw "Instruction fetch out of range";
  }
  var _instructions$pc = instructions[pc],
      instruction = _instructions$pc.instruction,
      parameters = _instructions$pc.parameters;
  ...
  switch (instruction) {
    ...
    case 'CYCLE':
      ...
      break;
    case 'ADD':
      var _pop_stack = pop_stack(stack),
          _pop_stack2 = _slicedToArray(_pop_stack, 2),
          x = _pop_stack2[0],
          stack = _pop_stack2[1];

      var _pop_stack3 = pop_stack(stack),
          _pop_stack4 = _slicedToArray(_pop_stack3, 2),
          y = _pop_stack4[0],
          stack = _pop_stack4[1];
      ...
      break;
    case 'LESS':
      var _pop_stack5 = pop_stack(stack),
          _pop_stack6 = _slicedToArray(_pop_stack5, 2),
          x = _pop_stack6[0],
          stack = _pop_stack6[1];

      var _pop_stack7 = pop_stack(stack),
          _pop_stack8 = _slicedToArray(_pop_stack7, 2),
          y = _pop_stack8[0],
          stack = _pop_stack8[1];
    ...
    case 'BZERO':
      ...
      var _pop_stack9 = pop_stack(stack),
          _pop_stack10 = _slicedToArray(_pop_stack9, 2),
          x = _pop_stack10[0],
          stack = _pop_stack10[1];
...
var machine = function machine() {
  ...
  switch (action.type) {
    ...
    case 'STEP':
      try {
        var _run_instruction = run_instruction(state.pc, state.instructions, state.stack),
            _run_instruction2 = _slicedToArray(_run_instruction, 2),
            pc = _run_instruction2[0],
            stack = _run_instruction2[1];

        return _extends({}, state, { pc: pc, stack: stack });
      } catch (err) {
        alert(err);
        return state;
      }
...
require.alias("symbol-observable/lib/index.js", "symbol-observable");process = require('process');require.register("___globals___", function(exports, require, module) {
